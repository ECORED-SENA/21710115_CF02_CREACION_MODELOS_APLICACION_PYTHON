  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Creación de modelos
        p.mb-4 Conocer los comandos más importantes en la construcción de modelos para aplicarlos en el análisis de datos a partir de las necesidades y requerimientos organizacionales.
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        ...
        p.mb-4 Identificar los principales elementos para la aplicación del modelo #[em Machine Learning] en la solución de problemas tomando como base los objetivos organizaciones
        .tarjeta.actividad.p-3
          .row.justify-content-around.align-items-center            
            .col-sm.mb-3.mb-sm-0
